    ...
    (function (PfSkin) {
        var ProgressBarStruct = /** @class */ (function (_super) {
            ...
            ProgressBarStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "ProgressBar"));
            };
            ...
            ProgressBarStruct.URL = "ui://s33x8418mywn1ka";
            ProgressBarStruct.DependPackages = ["PfSkin"];
            return ProgressBarStruct;
        }(fairygui.GProgressBar));
        PfSkin.ProgressBarStruct = ProgressBarStruct;
