    ...
    (function (BlackSkin) {
        var TextInputStruct = /** @class */ (function (_super) {
            ...
            TextInputStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("BlackSkin", "TextInput"));
            };
            ...
            TextInputStruct.URL = "ui://s1uxc7tgjmop2k";
            TextInputStruct.DependPackages = ["BlackSkin"];
            return TextInputStruct;
        }(fairygui.GLabel));
        BlackSkin.TextInputStruct = TextInputStruct;
