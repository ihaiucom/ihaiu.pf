    ...
    (function (PfSkin) {
        var WarFilmTypeItemStruct = /** @class */ (function (_super) {
            ...
            WarFilmTypeItemStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "WarFilmTypeItem"));
            };
            ...
            WarFilmTypeItemStruct.URL = "ui://s33x8418r8ay1fb";
            WarFilmTypeItemStruct.DependPackages = ["PfSkin"];
            return WarFilmTypeItemStruct;
        }(fairygui.GLabel));
        PfSkin.WarFilmTypeItemStruct = WarFilmTypeItemStruct;
