    ...
    (function (BlackSkin) {
        var TextAreaStruct = /** @class */ (function (_super) {
            ...
            TextAreaStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("BlackSkin", "TextArea"));
            };
            TextAreaStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_title = (this.getChild("title"));
            };
            TextAreaStruct.URL = "ui://s1uxc7tgjmop2m";
            TextAreaStruct.DependPackages = ["BlackSkin"];
            return TextAreaStruct;
        }(fairygui.GLabel));
        BlackSkin.TextAreaStruct = TextAreaStruct;
