    ...
    (function (BlackSkin) {
        var CheckboxStruct = /** @class */ (function (_super) {
            ...
            CheckboxStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("BlackSkin", "Checkbox"));
            };
            ...
            CheckboxStruct.URL = "ui://s1uxc7tgjmop8";
            CheckboxStruct.DependPackages = ["BlackSkin"];
            return CheckboxStruct;
        }(fairygui.GButton));
        BlackSkin.CheckboxStruct = CheckboxStruct;
