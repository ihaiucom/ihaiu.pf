    ...
    (function (PfSkin) {
        var DialogStruct = /** @class */ (function (_super) {
            ...
            DialogStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("PfSkin", "Dialog"));
            };
            DialogStruct.prototype.constructFromXML = function (xml) {
                _super.prototype.constructFromXML.call(this, xml);
                this.m_title = (this.getChild("title"));
            };
            DialogStruct.URL = "ui://s33x8418js171nw";
            DialogStruct.DependPackages = ["PfSkin"];
            return DialogStruct;
        }(fairygui.GComponent));
        PfSkin.DialogStruct = DialogStruct;
