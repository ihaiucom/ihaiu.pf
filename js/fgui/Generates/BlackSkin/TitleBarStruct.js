    ...
    (function (BlackSkin) {
        var TitleBarStruct = /** @class */ (function (_super) {
            ...
            TitleBarStruct.createInstance = function () {
                return (fairygui.UIPackage.createObject("BlackSkin", "TitleBar"));
            };
            ...
            TitleBarStruct.URL = "ui://s1uxc7tgjmop3a";
            TitleBarStruct.DependPackages = ["BlackSkin"];
            return TitleBarStruct;
        }(fairygui.GButton));
        BlackSkin.TitleBarStruct = TitleBarStruct;
    })(BlackSkin = fgui.BlackSkin || (fgui.BlackSkin = {}));
})(fgui || (fgui = {}));
//# sourceMappingURL=TitleBarStruct.js.map